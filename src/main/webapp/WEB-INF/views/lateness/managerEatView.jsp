        ...
        <tbody>
            <c:forEach var="lateness" items="${LatenessDTOList}">
                <tr>
				    ...
				    <td>
					    <a href="/lateness/eatApprove?employee_id=${lateness.employee_id}&ness_date=${lateness.ness_date}">승인</a>
					    <a href="/lateness/eatDeny?employee_id=${lateness.employee_id}&ness_date=${lateness.ness_date}">미승인</a>
					</td>
                </tr>
            </c:forEach>
        </tbody>
